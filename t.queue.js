(function(type, undefined){
	...
	type.Queue.prototype = {
		isEmpty: function(){return this.__innerList__.isEmpty();},
		...
		forEach: function(fn){this.__innerList__.forEach(fn);},

		map: function(fn){return this.__innerList__.map(fn);},

		toArray: function(){return this.__innerList__.toArray();}
	};
}(window.T = window.T || {}));