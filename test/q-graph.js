test('Graph constructor and properties, Part I', function(){
	...
	throws(function(){g1.__pushEdge__();}, 'the edge pushed into graph must be with two numeric endpoints');
...
test('Graph algorithm', function(){
	...
	.forEach(function(e){g1.__pushEdge__(e[0], e[1]);});
	...
	[59, [64]]].forEach(function(x){
		var v = x[0];
		x[1].forEach(function(u){g2.__pushEdge__(v, u, true);});
	});
	...
	deepEqual(
		Graph.dijkstra(g3).map(function(x){return x[1];}), 
